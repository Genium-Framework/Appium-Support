 ...
 * correctly in case the user provided a custom server installation directory.
 *
 * @author Hassan Radi
 */
public class CustomAppiumServerInstallationTest {
    ...
    public void setUp() {
        ...
        _appiumServer = new AppiumServer(new File("C:/Appium"), serverArguments);
    ...
    @Test
    public void checkServerIsRunningWithCustomInstallation() {
