 ...
 * correctly in case the user is using default Appium installation directory.
 *
 * @author Hassan Radi
 */
public class DefaultAppiumServerInstallationTest {
    ...
    @Test
    public void checkServerIsRunningWithDefaultInstallation() {
